...
export const cosmeticCatalog=[
  ...
  {id:'sapphire_sovereign_character',slot:'character',theme:'藍鑽至尊',name:'藍鑽至尊賓客',icon:'💎',price:52_000_000,image:'sapphire-sovereign.png',style:'sapphire'},
  {id:'aurora_circuit_character',slot:'character',theme:'極光賽道',name:'極光賽道先鋒',icon:'🏁',price:56_000_000,image:'aurora-circuit-racer.png',style:'aurora'},
  {id:'jade_tide_character',slot:'character',theme:'翡翠潮汐',name:'翡翠潮汐船長',icon:'⚓',price:60_000_000,image:'jade-tide-captain.png',style:'jade_tide'},
  {id:'starlight_archive_character',slot:'character',theme:'星光典藏',name:'星光典藏館長',icon:'🌌',price:64_000_000,image:'starlight-archive-curator.png',style:'starlight'},
  ...
  {id:'heist_headwear',slot:'headwear',theme:'暗夜劫案',name:'紫影戰術耳機',icon:'🎧',price:4_000_000,image:'heist/headwear-open.png',style:'heist'},
  {id:'heist_face',slot:'face',theme:'暗夜劫案',name:'紫影戰術鏡',icon:'🥽',price:3_000_000,image:'heist/face-open.png',style:'heist'},
